      ...
      content: (
        <div className="flex flex-col items-start lg:items-center">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {["Ruby", "Angular", "React Native", "TypeScript"].map((tech) => (
      ...
      content: (
        <div className="flex flex-col items-start lg:items-center">
          <Image
            ...
            width={400}
            height={400}
            className="rounded-lg object-cover h-auto max-w-[200px] md:max-w-[400px] border-8 border-white"
          />
          <p className="text-white text-xl font-semibold mt-4 text-left md:text-center">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {["React.js", "JavaScript", "Django", "Postman", "Github", "Jira"].map((tech) => (
              <Badge key={tech} label={tech} variant="outlined" />
            ))}
          </div>
        </div>
