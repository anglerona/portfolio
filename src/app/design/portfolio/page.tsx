...
const Portfolio = () => {
  return (
    <FadeInSection immediate={true}> {/* Immediate render on page load */}
      <div className="relative">
        ...
        <div className="relative text-center z-10">
          <FadeInSection immediate={true}> {/* Immediate render */}
            <div className="w-full pt-12 flex justify-center">
              <BackButton />
            </div>
            <h2 className="py-12 font-semibold text-4xl text-center">
          ...
          <div className="w-full mx-auto pb-20 lg:w-[1000px] px-4 aspect-auto">
            ...
            <FadeInSection>
              ...
              <p className="pt-4">Created web page prototypes in Figma</p>
            </FadeInSection>
          </div>
          ...
          <FadeInSection>
            <div className="w-full mx-auto lg:w-[1000px] px-4 aspect-auto">
              ...
              <p className="pt-4">Created personal portfolio style guide in Figma</p>
            </div>
          </FadeInSection>
